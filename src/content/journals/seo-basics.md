...
GA4を導入すると、計測のために`gtag.js`（135kB程度）を読み込むことになる。Astroを選んだ理由の一つは、できるだけシンプルで軽量なサイトにしたかったから。もちろん`gtag.js`だけで劇的に遅くなるわけではないと思うけど、それでも、「本当に必要なのか」が気になった。
...
ということで、現時点ではGA4は導入しないことにした。

ちょうどGoogleのFounder's letterにある
...
今はAIが直接回答を生成する検索も増えているのと思うので、これに対する取り組みはどうしたらいいか？
念のためChatGPT・Gemini・Claudeに聞いてみる。

基本的には全員？AI用のハックではなく、以下のような王道のSEOを固めろという回答。

- わかりやすいHTML構造
- 独自性・専門性のあるコンテンツ
- サイト外での情報発信や引用

結局のところ、AI向けだからと特別なことをするよりも、自分で考えたことや経験を、検索エンジンにも人にも読みやすい形で発信することが一番大切なのだと思う。

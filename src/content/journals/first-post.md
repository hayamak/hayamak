---
title: ウェブサイトの作成
description: 最近の技術の確認とキャッチアップを目的に、ウェブサイトを作成してみました。
pubDate: 2026-06-20
---

最近の技術の確認とキャッチアップを目的にウェブサイトを作成してみました。
...
最近の技術の確認が主目的なので、コンテンツはダミーでも良いっちゃ良いんだけど。でも、それだとすぐに飽きてしまって続かない気がするので、技術の話題の他に、音楽、スペイン語、スノーボード、ジムなど自分の関心ごとについて記録します。

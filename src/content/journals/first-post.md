---
title: ウェブサイトの作成
description: 技術の検証を目的に、久しぶりにウェブサイトを作成してみました。
pubDate: 2026-06-21
---

最近の技術の検証を目的に久しぶりにウェブサイトを作成してみました。

## 何で作るか

まずは使用するツールの選定から。Vanilla HTML/CSS/JavaScriptとWordPressは検討対象外。で、主に以下の３つの選択肢かな〜と。
